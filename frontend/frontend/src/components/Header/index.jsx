...
const ResponsiveAppBar = () => {
  ...
  if (isAdmin(email)) {
    pages = [
      ...pages,
      { label: "Create Clinic", link: "/admin/clinic" },
      { label: "Create Vaccine", link: "/admin/vaccine" },
      { label: "Create Disease", link: "/admin/disease" },
      { label: "Admin Report", link: "/admin/report" },
    ];
  }
